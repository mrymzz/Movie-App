...
function opens()
{
    if ($("nav").css("margin-left") == "250px") {
        ...
        $('.menu ul li').animate({"paddingTop":"25px","opacity":"1"},2000);
...
function closes() 
{
    $('.menu ul li').animate({"paddingTop":"250px","opacity":"0"},2000);
